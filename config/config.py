...
token: str = "Nzk4NTkwODUyMjA4OTE4NTYw.X_3PsA.Ww04INjfvcdyZ4260E59jKyWFN0"
DEFAULT_NICKNAME = "GopnikMusicBot"
...
ADD_MESSAGE_1 = """```Gopnik Bot Cyka Blyat.```"""
ADD_MESSAGE_2 = "By Gopnik Cheemz"
...
HELP_ADDBOT_SHORT = "I have given free use of the code."
HELP_ADDBOT_LONG  = "I will be posting it on github and this message will be replaced with the url."
...
HELP_YT_LONG = ("Plays the audio of a Youtube video. It can either be:\n"
                "  - A link to the video (https://www...)\n"
                "  - The title of a video (DJ Blyatman & Russian Village Boys - CYKA BLYAT (Official Music Video))\n" 
                "  - Keywords for a search(Russian Hard Bass) -> the bot plays the first result)\n"
